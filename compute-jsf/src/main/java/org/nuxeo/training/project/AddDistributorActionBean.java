...
/**
 * Code skeleton for a Seam bean that will manage a simple action. This can be used to : - do a navigation - do some
 * modification on the currentDocument (or other docs) - create new documents - send/retrieve info from an external
 * service - ...
 */
